...
export default function MissionComponent(props){
    ...
    return(
        <div className={css({display: props.display, flexDirection: props.direction, justifyContent: props.justify, alignItems: props.align, position: props.position, top: props.top, marginLeft: props.left, height: props.height, width: props.width})} >
