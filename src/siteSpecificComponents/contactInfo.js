...
export default function ContactInfo(props){
    ...
    return(
        <div className={css({display: props.display, flexDirection: props.direction1, justifyContent: props.justify1, alignItems: props.align1, height: props.height1, width: props.width1, backgroundColor: props.backgroundColor1})}>
            <div className={css({display: props.display, flexDirection: props.direction3, justifyContent: props.justify3, alignItems: props.align3, height: props.height4, width: props.width4})}>
                ...
                <div className={css({display: props.display, flexDirection: props.direction2, justifyContent: props.justify2, alignItems: props.align2, height: props.height2, width: props.width2, marginTop: props.marginTop1})}>
                ...
                <div className={css({height: props.height3, width: props.width3, backgroundColor: props.backgroundColor2, marginTop: props.marginTop2})}></div>
                <div className={css({display: props.display, flexDirection: props.direction2, justifyContent: props.justify2, alignItems: props.align2, height: props.height2, width: props.width2, marginRight: props.marginRight, marginTop: props.marginTop1})}>
